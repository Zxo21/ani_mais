                ...
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="card card-body">
                            ...
                            <p><?php echo "Obs: ". utf8_encode($verificadorVacina['observacao'])?></p>
                                                    </div>
                        </div>
                    </div>
                </div>
              ...
              <div class="row w-75">
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                        <div class="card card-body">
                        <p><b><?php echo utf8_encode($verificadorComorbidade['nome']);?></b></p>
                            <p><?php echo utf8_encode($verificadorComorbidade['descricao'])?></p>
                            <p><?php echo "Obs: ". utf8_encode($verificadorComorbidade['observacao'])?></p>
                                                   </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                        <div class="card card-body">
                            ...
                            <p><?php echo "Obs: ". utf8_encode($verificadorMedicacao['observacao'])?></p>
                          </div>
                        </div>
                    </div>
                </div>
